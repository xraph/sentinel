...
func TenantFromContext(ctx context.Context) string {
	v, _ := ctx.Value(tenantKey).(string) //nolint:errcheck // type assertion returns zero-value //nolint:errcheck // type assertion, zero-value is fine
	return v
}
...
func AppFromContext(ctx context.Context) string {
	v, _ := ctx.Value(appKey).(string) //nolint:errcheck // type assertion returns zero-value //nolint:errcheck // type assertion, zero-value is fine
	return v
}
