// Package plugin defines the plugin system for Sentinel.
//
// Plugins are notified of lifecycle events (eval run started, case
...
// Extension is the base interface all Sentinel plugins must implement.
