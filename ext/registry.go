...
// EmitEvalRunStarted notifies all extensions that implement EvalRunStarted.
...
// EmitEvalRunCompleted notifies all extensions that implement EvalRunCompleted.
...
// EmitEvalRunFailed notifies all extensions that implement EvalRunFailed.
...
// EmitCaseStarted notifies all extensions that implement CaseStarted.
...
// EmitCaseCompleted notifies all extensions that implement CaseCompleted.
...
// EmitCaseFailed notifies all extensions that implement CaseFailed.
...
// EmitRegressionDetected notifies all extensions that implement RegressionDetected.
...
// EmitBaselineSaved notifies all extensions that implement BaselineSaved.
...
// EmitRedTeamStarted notifies all extensions that implement RedTeamStarted.
...
// EmitRedTeamCompleted notifies all extensions that implement RedTeamCompleted.
...
// EmitPersonaEvalStarted notifies all extensions that implement PersonaEvalStarted.
...
// EmitPersonaEvalCompleted notifies all extensions that implement PersonaEvalCompleted.
...
// EmitPromptVersionCreated notifies all extensions that implement PromptVersionCreated.
...
// EmitComparisonCompleted notifies all extensions that implement ComparisonCompleted.
